...
#### Hosts-Clean - Cleaner hosts with different name(Adblock-lean)(Warning:Addons needs to be manually allowed on Adblock-lean) - [Codeberg](https://codeberg.org/privacyfilters/Mozilla-Blocker/raw/branch/main/hosts-clean) - [Github](https://raw.githubusercontent.com/privacyfilters/Mozilla-Blocker/main/hosts-clean)
...
## 3. [yokoffing filterlists](https://github.com/yokoffing/filterlists) - Recommened for most general Users. A balanced sets of adblocking and privacy filter selection for adblockers like Ublock Origin, Adguard and Brave browser.
...
Makes tones of home calls to zen browser domain. you should just block zen-browser.app domain, and install the borwser with a package manager of your linux distro, UnigetUi for microsoft widnows(winget,chocoletey) or just directly download the installer from their [github releases](https://github.com/zen-browser/desktop/releases).

## 7. [Floorp Browser](https://floorp.app/) - A good looking, customizable and performant firefox fork. Used to be called vivaldi of firefox by many. Not Privacy focused.
